...
class TestSPMF:
    ...
    def test_spmf_output_format(self):
        ...
        spmf, _ = my_spmf(self.input_file, 1, 3)
        pattern = re.compile(
    ...
    def test_spmf_output_stats(self):
        ...
        spmf, _ = my_spmf(self.input_file, tfd_leniency, tdd_leniency)
        sequence_lines = get_sequences(self.input_file)[0]
    ...
    def test_spmf_lines_match_pairs(self):
        ...
        spmf, map = my_spmf(self.input_file, 1, 3)
    ...
    def test_spmf_intracommit_order_changes_nothing(self):
        ...
        spmf1, _ = my_spmf(self.input_file, 1, 3)
        # shuffle_hash_lines(self.input_file, self.shuffle_file)
        spmf2, _ = my_spmf(self.shuffle_file, 1, 3)
